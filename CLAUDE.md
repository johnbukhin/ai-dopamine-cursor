...
- The canonical paywall data (EUR pricing, correct disclaimers) lives in `funnel/funnel-v2/screens.json`.
- When creating new funnels based on v2, copy screens.json from there — not from any pre-Issue-#17 backup files.
