...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-purple-800 text-white hover:bg-purple-900 focus:ring-purple-800",
    secondary: "bg-gray-200 text-purple-900 hover:bg-gray-300 focus:ring-gray-400",
    danger: "bg-red-100 text-red-800 hover:bg-red-200 focus:ring-red-200",
    ghost: "bg-transparent text-purple-800 hover:bg-gray-100",
  };
